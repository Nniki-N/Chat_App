...
ChatModel _$ChatModelFromJson(Map<String, dynamic> json) => ChatModel(
      ...
      chatContactUserId: json['chat_contact_user_id'] as String,
      isChatContactUserOline: json['is_chat_contact_user_oline'] as bool,
...
Map<String, dynamic> _$ChatModelToJson(ChatModel instance) => <String, dynamic>{
      ...
      'chat_contact_user_id': instance.chatContactUserId,
      'is_chat_contact_user_oline': instance.isChatContactUserOline,
